...
const UI = {
  en: {
    ...
    lnHangul: 'Reading Korean',
    lnStart: (n) => n === 1 ? 'Teach me a letter' : `Teach me ${n} letters`,
    lnTaskDo: 'I found it in the wild!',
    lnTaskDone: 'Found in the wild',
    lnMotifs: 'Spot these here',
    lnLocked: 'Check in to unlock',
    lnLetters: 'Letters', lnMotifsStat: 'Motifs',
    ...
    tlClose: 'Close',
    tlGap: (n) => `${n.toLocaleString('en')} years · not to scale`,
  ...
  zh: {
    ...
    tlFindOnMap: '在地圖上找',
    tlClose: '關閉',
    tlGap: (n) => `${n.toLocaleString('zh-TW')} 年 · 非等比`,
    tlSeed: '加入韓國歷史',
