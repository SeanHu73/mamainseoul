...
const UI = {
  en: {
    ...
    stopsVisited: 'Stops', huntsDone: 'Finds', triviaRight: 'Trivia',
    ...
    qFind: 'I found it!',
    qFound: 'Found — story unlocked',
    qCallback: (place) => `You met this at ${place}`,
    qThemes: 'Themes',
  ...
  zh: {
    ...
    stopsVisited: '打卡', huntsDone: '找到', triviaRight: '答對',
